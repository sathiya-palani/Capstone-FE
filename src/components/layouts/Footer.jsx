        ...
        <div className="row">
            <div className="col-4 text-center">
               ...
               <span className="d-block mt-1">A108, Adam Street</span>
                ...
                <span className="d-block mt-1 end-email"> info@yahoo.com</span>
               </div>
            </div>
            <div className="col-4">
            {/* <h4 className="text-center fw-bold">Links</h4> */}
            ...
            <div className="col-4">
                <h4 className="text-center fw-bold">Our Assurances</h4>
              <div className="d-flex justify-content-center" style={{fontStyle:'italic'}}>
    

                <ul>
                    <li className="" ><i class="fas fa-gift" style={{color: '#211ec8'}}></i> Gifting</li>
                    <li className=""> <i class="fas fa-tags" style={{color:'#1e23be'}}></i>  Festival Offers</li>
                    <li className=""><i class="fas fa-shield-alt"  style={{color:'#1e23be'}}></i> 100% Secure Payment</li>
                    <li className=""><i class="fas fa-undo" style={{color:'#1e23be'}}></i> Returns & Refunds</li>
                    <li className=""><i class="fas fa-phone-square-alt" style={{color:'#1e23be'}}></i>  customer support</li>
                </ul>
              </div>
            </div>
        </div>
